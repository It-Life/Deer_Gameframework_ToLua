...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    internal sealed partial class ResourceEditor : EditorWindow
    {
        ...
        private void DrawSourceAssetsMenu()
        {
            ...
            GUILayout.Label(string.Empty);
            if (GUILayout.Button("AllPacked", GUILayout.Width(80f)))
            {
        ...
        private void DrawSourceFolder(SourceFolder sourceFolder)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                #region 新加的设置一个文件夹为一个Bundle
                if (GUILayout.Button($"添加【{sourceFolder.Name}】此项为一个Bundle",GUILayout.Width(300f),GUILayout.Height(18f)))
                {
