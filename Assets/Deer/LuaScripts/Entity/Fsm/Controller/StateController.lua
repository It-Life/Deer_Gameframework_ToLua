...
---@field s_deathState DeathState
---@field s_attackState AttackState
...
function StateController:__init(owner)
    ...
    self.s_deathState = DeathState.New(self:GetOwner(),CharacterStateEnum.DeathState)
    self.s_dicState[CharacterStateEnum.DeathState] = self.s_deathState
    self.s_attackState = AttackState.New(self:GetOwner(),CharacterStateEnum.AttackState)
    self.s_dicState[CharacterStateEnum.AttackState] = self.s_attackState
