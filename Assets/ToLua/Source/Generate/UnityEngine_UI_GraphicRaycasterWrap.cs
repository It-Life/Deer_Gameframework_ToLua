...
public class UnityEngine_UI_GraphicRaycasterWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("ignoreReversedGraphics", new LuaCSFunction(get_ignoreReversedGraphics), new LuaCSFunction(set_ignoreReversedGraphics));
		L.RegVar("blockingObjects", new LuaCSFunction(get_blockingObjects), new LuaCSFunction(set_blockingObjects));
		L.RegVar("blockingMask", new LuaCSFunction(get_blockingMask), new LuaCSFunction(set_blockingMask));
	...
	static int set_blockingObjects(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GraphicRaycaster obj = (UnityEngine.UI.GraphicRaycaster)o;
			UnityEngine.UI.GraphicRaycaster.BlockingObjects arg0 = (UnityEngine.UI.GraphicRaycaster.BlockingObjects)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.UI.GraphicRaycaster.BlockingObjects>.type);
