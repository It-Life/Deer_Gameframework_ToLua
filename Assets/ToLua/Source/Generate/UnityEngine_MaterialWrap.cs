...
public class UnityEngine_MaterialWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOVector", new LuaCSFunction(DOVector));
		L.RegFunction("DOTiling", new LuaCSFunction(DOTiling));
		L.RegFunction("DOOffset", new LuaCSFunction(DOOffset));
		L.RegFunction("DOFloat", new LuaCSFunction(DOFloat));
