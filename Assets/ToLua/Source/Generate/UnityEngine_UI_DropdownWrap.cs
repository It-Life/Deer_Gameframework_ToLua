...
public class UnityEngine_UI_DropdownWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("RefreshShownValue", new LuaCSFunction(RefreshShownValue));
		L.RegFunction("AddOptions", new LuaCSFunction(AddOptions));
		L.RegFunction("ClearOptions", new LuaCSFunction(ClearOptions));
		L.RegFunction("OnPointerClick", new LuaCSFunction(OnPointerClick));
		L.RegFunction("OnSubmit", new LuaCSFunction(OnSubmit));
		L.RegFunction("OnCancel", new LuaCSFunction(OnCancel));
		...
		L.RegVar("captionText", new LuaCSFunction(get_captionText), new LuaCSFunction(set_captionText));
		L.RegVar("captionImage", new LuaCSFunction(get_captionImage), new LuaCSFunction(set_captionImage));
		L.RegVar("itemText", new LuaCSFunction(get_itemText), new LuaCSFunction(set_itemText));
		L.RegVar("itemImage", new LuaCSFunction(get_itemImage), new LuaCSFunction(set_itemImage));
		L.RegVar("options", new LuaCSFunction(get_options), new LuaCSFunction(set_options));
		L.RegVar("onValueChanged", new LuaCSFunction(get_onValueChanged), new LuaCSFunction(set_onValueChanged));
		L.RegVar("alphaFadeSpeed", new LuaCSFunction(get_alphaFadeSpeed), new LuaCSFunction(set_alphaFadeSpeed));
	...
	static int set_options(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.Dropdown obj = (UnityEngine.UI.Dropdown)o;
			System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData> arg0 = (System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>)ToLua.CheckObject(L, 2, TypeTraits<System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>>.type);
			obj.options = arg0;
			return 0;
		}
		catch(Exception e)
