...
public class UnityEngine_CanvasWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetDefaultCanvasMaterial", new LuaCSFunction(GetDefaultCanvasMaterial));
		L.RegFunction("GetETC1SupportedCanvasMaterial", new LuaCSFunction(GetETC1SupportedCanvasMaterial));
		L.RegFunction("ForceUpdateCanvases", new LuaCSFunction(ForceUpdateCanvases));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Canvas));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("renderMode", new LuaCSFunction(get_renderMode), new LuaCSFunction(set_renderMode));
		L.RegVar("isRootCanvas", new LuaCSFunction(get_isRootCanvas), null);
		L.RegVar("pixelRect", new LuaCSFunction(get_pixelRect), null);
		...
		L.RegVar("overridePixelPerfect", new LuaCSFunction(get_overridePixelPerfect), new LuaCSFunction(set_overridePixelPerfect));
		L.RegVar("pixelPerfect", new LuaCSFunction(get_pixelPerfect), new LuaCSFunction(set_pixelPerfect));
		L.RegVar("planeDistance", new LuaCSFunction(get_planeDistance), new LuaCSFunction(set_planeDistance));
		L.RegVar("renderOrder", new LuaCSFunction(get_renderOrder), null);
		L.RegVar("overrideSorting", new LuaCSFunction(get_overrideSorting), new LuaCSFunction(set_overrideSorting));
		...
		L.RegVar("cachedSortingLayerValue", new LuaCSFunction(get_cachedSortingLayerValue), null);
		L.RegVar("additionalShaderChannels", new LuaCSFunction(get_additionalShaderChannels), new LuaCSFunction(set_additionalShaderChannels));
		L.RegVar("sortingLayerName", new LuaCSFunction(get_sortingLayerName), new LuaCSFunction(set_sortingLayerName));
		L.RegVar("rootCanvas", new LuaCSFunction(get_rootCanvas), null);
		L.RegVar("renderingDisplaySize", new LuaCSFunction(get_renderingDisplaySize), null);
		L.RegVar("worldCamera", new LuaCSFunction(get_worldCamera), new LuaCSFunction(set_worldCamera));
		L.RegVar("normalizedSortingGridSize", new LuaCSFunction(get_normalizedSortingGridSize), new LuaCSFunction(set_normalizedSortingGridSize));
		L.RegVar("preWillRenderCanvases", new LuaCSFunction(get_preWillRenderCanvases), new LuaCSFunction(set_preWillRenderCanvases));
		L.RegVar("willRenderCanvases", new LuaCSFunction(get_willRenderCanvases), new LuaCSFunction(set_willRenderCanvases));
		L.RegFunction("WillRenderCanvases", new LuaCSFunction(UnityEngine_Canvas_WillRenderCanvases));
		L.EndClass();
	}
	...
	static int set_additionalShaderChannels(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Canvas obj = (UnityEngine.Canvas)o;
			UnityEngine.AdditionalCanvasShaderChannels arg0 = (UnityEngine.AdditionalCanvasShaderChannels)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.AdditionalCanvasShaderChannels>.type);
