...
public class UnityEngine_CameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DORect", new LuaCSFunction(DORect));
		L.RegFunction("DOPixelRect", new LuaCSFunction(DOPixelRect));
		L.RegFunction("DOOrthoSize", new LuaCSFunction(DOOrthoSize));
		L.RegFunction("DONearClipPlane", new LuaCSFunction(DONearClipPlane));
		L.RegFunction("DOFieldOfView", new LuaCSFunction(DOFieldOfView));
		L.RegFunction("DOFarClipPlane", new LuaCSFunction(DOFarClipPlane));
		L.RegFunction("DOColor", new LuaCSFunction(DOColor));
		L.RegFunction("DOAspect", new LuaCSFunction(DOAspect));
