...
public class UnityEngine_UI_ScrollRectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("movementType", new LuaCSFunction(get_movementType), new LuaCSFunction(set_movementType));
		L.RegVar("elasticity", new LuaCSFunction(get_elasticity), new LuaCSFunction(set_elasticity));
		...
		L.RegVar("horizontalScrollbarVisibility", new LuaCSFunction(get_horizontalScrollbarVisibility), new LuaCSFunction(set_horizontalScrollbarVisibility));
		L.RegVar("verticalScrollbarVisibility", new LuaCSFunction(get_verticalScrollbarVisibility), new LuaCSFunction(set_verticalScrollbarVisibility));
		L.RegVar("horizontalScrollbarSpacing", new LuaCSFunction(get_horizontalScrollbarSpacing), new LuaCSFunction(set_horizontalScrollbarSpacing));
		L.RegVar("verticalScrollbarSpacing", new LuaCSFunction(get_verticalScrollbarSpacing), new LuaCSFunction(set_verticalScrollbarSpacing));
	...
	static int set_horizontalScrollbarVisibility(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.ScrollRect obj = (UnityEngine.UI.ScrollRect)o;
			UnityEngine.UI.ScrollRect.ScrollbarVisibility arg0 = (UnityEngine.UI.ScrollRect.ScrollbarVisibility)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.UI.ScrollRect.ScrollbarVisibility>.type);
